...
#import "IDAlgorithmListVC.h"
#import "IDTechListModel.h"

@interface IDAlgorithmListVC ()

@property (nonatomic, strong) IDTechListModel *model;

@end

@implementation IDAlgorithmListVC
...
- (void)viewDidLoad {
    ...
    NSString *techListDataFilePath = [[NSBundle mainBundle] pathForResource:@"IDAlgorithmList" ofType:@"json"];
