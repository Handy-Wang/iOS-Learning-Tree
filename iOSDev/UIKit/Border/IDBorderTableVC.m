...
#import "IDBorderTableVC.h"
#import "IDTechListModel.h"

@interface IDBorderTableVC ()

@property (nonatomic, strong) IDTechListModel *model;

@end

@implementation IDBorderTableVC
...
- (void)viewDidLoad {
    ...
    NSString *techListDataFilePath = [[NSBundle mainBundle] pathForResource:@"IDBorderTableVC" ofType:@"json"];
