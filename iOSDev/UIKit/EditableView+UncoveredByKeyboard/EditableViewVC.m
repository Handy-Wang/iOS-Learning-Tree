...
#import "EditableViewVC.h"
#import "IDTechListModel.h"

@interface EditableViewVC ()

@property (nonatomic, strong) IDTechListModel *model;

@end

@implementation EditableViewVC
...
- (void)viewDidLoad {
    ...
    NSString *techListDataFilePath = [[NSBundle mainBundle] pathForResource:@"EditableView" ofType:@"json"];
