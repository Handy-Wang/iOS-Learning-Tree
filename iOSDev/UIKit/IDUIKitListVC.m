...
#import "IDUIKitListVC.h"
#import "IDTechListModel.h"

@interface IDUIKitListVC ()

@property (nonatomic, strong) IDTechListModel *model;

@end

@implementation IDUIKitListVC
...
- (void)viewDidLoad {
    ...
    NSString *techListDataFilePath = [[NSBundle mainBundle] pathForResource:@"IDUIKitList" ofType:@"json"];
