...
#import "IDFoundationListVC.h"
#import "IDTechListModel.h"

@interface IDFoundationListVC ()

@property (nonatomic, strong) IDTechListModel *model;

@end

@implementation IDFoundationListVC
...
- (void)viewDidLoad {
    ...
    NSString *techListDataFilePath = [[NSBundle mainBundle] pathForResource:@"IDFoundationList" ofType:@"json"];
