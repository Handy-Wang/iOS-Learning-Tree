...
#import "IDCoreAnimationVC.h"
#import "IDTechListModel.h"

@interface IDCoreAnimationVC ()

@property (nonatomic, strong) IDTechListModel *model;

@end

@implementation IDCoreAnimationVC
...
- (void)viewDidLoad {
    ...
    NSString *techListDataFilePath = [[NSBundle mainBundle] pathForResource:@"IDCoreAnimation" ofType:@"json"];
